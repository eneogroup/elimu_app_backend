...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('backend', '0010_user_school_code_staffprofil'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='pupil_photos/', verbose_name='Photo')),
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='account_of_parent', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('matricule', backend.models.school_manager.school_manager.UUID4Field(auto_created=True, blank=True, max_length=17, unique=True)),
                ('lastname', models.CharField(blank=True, max_length=50, null=True, verbose_name='Nom')),
                ('firstname', models.CharField(blank=True, max_length=50, null=True, verbose_name='Prénom')),
                ('nickname', models.CharField(blank=True, max_length=50, null=True, verbose_name='Surnom')),
                ('gender', models.CharField(blank=True, choices=[('Masculin', 'Masculin'), ('Féminin', 'Féminin')], max_length=10, null=True, verbose_name='Sexe')),
