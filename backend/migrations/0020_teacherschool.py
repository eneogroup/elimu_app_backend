...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('backend', '0019_documenttype_sanctionorappreciationtype_subjectgroup_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher_school', to='backend.school', verbose_name='École')),
