    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_code', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.school', verbose_name='Code École')),
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.userrole', verbose_name='Rôle')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='account_of_parent', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parents', models.ManyToManyField(related_name='parents_of_pupils', to='backend.parentofstudent')),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pupil_profile', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Élève',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Élève', to='backend.pupil')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_code', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='teacher_school', to='backend.school', verbose_name='École')),
                ('subjects', models.ManyToManyField(blank=True, related_name='teachers', to='backend.subject', verbose_name='Matières enseignées')),
